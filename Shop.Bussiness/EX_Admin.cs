...
namespace Shop.Bussiness
{
    public class EX_Admin
    {
        ...
        /// <returns></returns>
        public static string DesEncrypt(string data, string key= "lzg@1112", string iv="lzg!1234")
        {
        ...
        /// <returns></returns>
        public static string DesDecrypt(string data, string key = "lzg@1112", string iv = "lzg!1234")
        {
            byte[] byKey = Encoding.ASCII.GetBytes(key);
            byte[] byIv = Encoding.ASCII.GetBytes(iv);
