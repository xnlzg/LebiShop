...
<body class="fix-sidebar fix-header card-no-border">
   ...
   <div id="main_index">
    ...
    plotOptions: {column: {pointPadding: 1,borderWidth: 0}},
        series: [{name: '<%=Tag("未确认") %>',data: [<%for(i=1; i<=15; i++){%><%=Shop.Bussiness.Order.GetMoney_Order(System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),"Type_id_OrderType = 211 and IsVerified = 0 and IsInvalid = 0") %><%if (i <15){Response.Write(", ");} %><%} %>]}, {name: '<%=Tag("未支付") %>',data: [<%for(i=1; i<=15; i++){%><%=Shop.Bussiness.Order.GetMoney_Order(System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),"Type_id_OrderType = 211 and IsPaid = 0") %><%if (i <15){Response.Write(", ");} %><%} %>]}, {name: '<%=Tag("已支付") %>',data: [<%for(i=1; i<=15; i++){%><%=Shop.Bussiness.Order.GetMoney_Order(System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),"Type_id_OrderType = 211 and IsVerified = 1 and IsPaid = 1 and IsInvalid = 0") %><%if (i <15){Response.Write(", ");} %><%} %>]},{name: '<%=Tag("未发货") %>',data: [<%for(i=1; i<=15; i++){%><%=Shop.Bussiness.Order.GetMoney_Order(System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),"Type_id_OrderType = 211 and IsVerified = 1 and IsShipped = 0 and IsInvalid = 0") %><%if (i <15){Response.Write(", ");} %><%} %>]},{name: '<%=Tag("已发货") %>',data: [<%for(i=1; i<=15; i++){%><%=Shop.Bussiness.Order.GetMoney_Order(System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),"Type_id_OrderType = 211 and IsVerified = 1 and IsShipped = 1") %><%if (i <15){Response.Write(", ");} %><%} %>]},{name: '<%=Tag("已收货") %>',data: [<%for(i=1; i<=15; i++){%><%=Shop.Bussiness.Order.GetMoney_Order(System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),"Type_id_OrderType = 211 and IsVerified = 1 and IsReceived = 1 and IsInvalid = 0") %><%if (i <15){Response.Write(", ");} %><%} %>]},{name: '<%=Tag("已完成") %>',data: [<%for(i=1; i<=15; i++){%><%=Shop.Bussiness.Order.GetMoney_Order(System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),System.DateTime.Now.AddDays(-15+i).ToString("yyyy-MM-dd"),"Type_id_OrderType = 211 and IsVerified = 1 and IsCompleted = 1") %><%if (i <15){Response.Write(", ");} %><%} %>]}]
    });});
    </script>
