<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.admin.Admin_Group_Edit_window" validateRequest="false"%>
    ...
    <script>
        ...
        function SaveObj() {
            ...
            var url = "<%=site.AdminPath %>/Ajax/ajax_admin.aspx?__Action=Admin_Group_Edit&id=<%=model.id %>";
