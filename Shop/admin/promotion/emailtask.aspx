            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 m-b-10">
                        <%if (PageReturnMsg == ""){%>
                        <a class="btn btn-info" href="emailtask_edit.aspx" target="_blank"><i class="ti-plus"></i> <%=Tag("添加")%></a>
                    ...
                    <table class="table table-hover no-wrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <%=model.IsSubmit==1?"<span class=\"label label-success\">" + Tag("已提交") + "</span>" : "<span class=\"label label-danger\">" + Tag("未提交") + "</span>"%>
                                </td>
                                ...
                                <td>
                                    <a href="emailtask_edit.aspx?id=<%=model.id %>" target="_blank"><%=model.IsSubmit==1?Tag("查看"):Tag("编辑") %></a>
                                </td>
                            </tr>
                            <%} %>
                        </tbody>
