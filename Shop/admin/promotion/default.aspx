...
<body class="fix-sidebar fix-header card-no-border">
    ...
    <h3 class="text-themecolor m-b-0 m-t-0"><%=Tag("优惠促销")%></h3>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<%=site.AdminPath %>/Ajax/ajax_admin.aspx?__Action=MenuJump&pid=0"><%=Tag("管理首页")%></a></li>
        <li class="breadcrumb-item active"><%=Tag("优惠促销")%></li>
    </ol>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 m-b-10">
                        <%if (PageReturnMsg == ""){%>
                        <button class="btn btn-info" onclick="Edit();"><i class="ti-plus"></i> <%=Tag("添加")%></button>
                    ...
                    <table class="table table-hover no-wrap">
                        ...
                        <tbody>
                            ...
                            <tr ondblclick="Edit(<%=model.id %>);">
                                ...
                                <td>
                                    <a href="javascript:Edit(<%=model.id %>);"><%=Tag("编辑")%></a> | <a href="Promotion.aspx?tid=<%=model.id %>"><%=Tag("编辑规则")%></a>
                                </td>
                            </tr>
                            <%} %>
                        </tbody>
