...
<body class="fix-sidebar fix-header card-no-border">
    ...
    <h3 class="text-themecolor m-b-0 m-t-0"><%=Tag("友情链接")%></h3>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<%=site.AdminPath %>/Ajax/ajax_admin.aspx?__Action=MenuJump&pid=0"><%=Tag("管理首页")%></a></li>
        <li class="breadcrumb-item active"><%=Tag("友情链接")%></li>
    </ol>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-9 m-b-10">
                        <%if (PageReturnMsg == ""){%>
                        <button class="btn btn-info" onclick="EditFirendLink(0)"><i class="ti-plus"></i> <%=Tag("添加")%></button>
                        ...
                        <button class="btn btn-default" onclick="UpdateLang(0,'FriendLink');"><i class="ti-world"></i> <%=Tag("语言")%></button>
                        <%}%>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover no-wrap">
                        ...
                        <tbody>
                            ...
                            <tr ondblclick="EditFirendLink(<%=model.id %>);">
                                <td>
                                ...
                                <td>
                                    <input type="text" name="Name<%=model.id %>" value="<%=model.Name %>" class="form-control form-control-sm" shop="true">
                                </td>
                                <td>
                                    <input type="text" name="Url<%=model.id %>" value="<%=model.Url %>" class="form-control form-control-sm" shop="true">
                                </td>
                                <td>
                                    <% if (model.Logo != ""){ %>
                                ...
                                <td>
                                    <select id="IsPic<%=model.id %>" shop="true" name="IsPic<%=model.id %>" class="form-control form-control-sm">
                                ...
                                <td>
                                    <select id="IsShow<%=model.id %>" shop="true" name="IsShow<%=model.id %>" class="form-control form-control-sm">
...
<div class="modal fade" id="Modal-Confirm" tabindex="-1" role="dialog" aria-labelledby="Confirm">
    ...
    <script>
        ...
        function EditFirendLink(id) {
            ...
            $("#EditModal").modal("show");
            $.ajax({
                url: "friendlink_edit_window.aspx",
                type: "GET",
                cache: false,
