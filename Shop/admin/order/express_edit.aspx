            ...
            <div class="card-body">
                <form action="javascript:SaveObj();" novalidate>
                    <div class="form-group">
                        <label for="SkinContent"><%=Tag("添加项目")%>：</label>
                        <select id="items" name="items" class="form-control" onchange="add_item()">
