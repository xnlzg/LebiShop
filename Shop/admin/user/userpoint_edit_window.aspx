    ...
    <form action="javascript:SaveObj();" novalidate>
        ...
        <div class="modal-body" style="max-height:500px;overflow-y:auto;">
            ...
            <div class="form-group">
                ...
                <input type="text" id="Point" name="Point" value="<%=Point %>" class="form-control" shop="true" onkeyup="value=value.replace(/[^-\d\.]/g,'');" required>
            </div>
            <div class="form-group">
                <label for="Type_id_PointStatus"><%=Tag("状态")%>：</label>
    ...
    <script>
        ...
        function UType(n){
	        if (n==0){
	            ...
	            $("#User_Name_To").removeAttr("required");
		        $("#showuser").hide();
                $("#showuserlevel").show();
	        }
        }
