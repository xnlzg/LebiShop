<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.storeConfig.BillType_Edit_window" validateRequest="false"%>
    ...
    <form action="javascript:SaveObj();" novalidate>
        ...
        <div class="modal-body" style="max-height:500px;overflow-y:auto;">
            ...
            <div class="tab-content m-t-20">
                ...
                <div class="tab-pane <%if (langs.FirstOrDefault().Code == lang.Code){%>active show<%}%>" id="lang_<%=lang.Code %>" role="tabpanel">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="Description<%=lang.Code %>" name="Description<%=lang.Code %>" shop="true" class="form-control" style="height:60px;"><%=Shop.Bussiness.Language.Content(model.Description,lang.Code) %></textarea>
            ...
            <div class="form-group">
                <label for="Type_id_BillType"><%=Tag("类型")%>：</label>
            ...
            <div class="form-group">
                ...
                <textarea id="Content" name="Content" shop="true" class="form-control" style="height:60px;"><%=model.Content%></textarea>
                <div class="button-group m-t-5">
            ...
            <div class="form-group">
                <label for="TaxRate"><%=Tag("税率")%>：</label>
                <input type="text" id="TaxRate" name="TaxRate" value="<%=model.TaxRate %>" class="form-control" shop="true">
            </div>
            <div class="form-group">
