...
<body class="fix-sidebar fix-header card-no-border">
    ...
    <h3 class="text-themecolor m-b-0 m-t-0"><%=Tag("数据清理")%></h3>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<%=site.AdminPath %>/Ajax/ajax_admin.aspx?__Action=MenuJump&pid=0"><%=Tag("管理首页")%></a></li>
        <li class="breadcrumb-item active"><%=Tag("数据清理")%></li>
    </ol>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 m-b-10">
                        <%if (PageReturnMsg == ""){%>
                        <button class="btn btn-success" onclick="DeleteConfirm()"><i class="ti-check"></i> <%=Tag("清理")%></button>
                        <%}%>
                    </div>
                </div>
                    ...
                    <table class="table table-hover no-wrap">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" id="checkbox_product" name="datatype" value="product" class="custom-control-input" power="true">
                            ...
                            <tr>
                                <td>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" id="checkbox_user" name="datatype" value="user" class="custom-control-input" power="true">
                                        <span class="custom-control-label"></span>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" id="checkbox_order" name="datatype" value="order" class="custom-control-input" power="true">
                                        <span class="custom-control-label"></span>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" id="checkbox_log" name="datatype" value="log" class="custom-control-input" power="true">
                                        <span class="custom-control-label"></span>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" id="checkbox_userpoint" name="datatype" value="userpoint" class="custom-control-input" power="true">
                                        <span class="custom-control-label"></span>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" id="checkbox_usermoney" name="datatype" value="usermoney" class="custom-control-input" power="true">
                                        <span class="custom-control-label"></span>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" id="checkbox_card" name="datatype" value="card" class="custom-control-input" power="true">
                                        <span class="custom-control-label"></span>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" id="checkbox_message" name="datatype" value="message" class="custom-control-input" power="true">
                                        <span class="custom-control-label"></span>
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" id="checkbox_userproduct" name="datatype" value="userproduct" class="custom-control-input" power="true">
                                        <span class="custom-control-label"></span>
                                    </label>
                                </td>
                                <td>
