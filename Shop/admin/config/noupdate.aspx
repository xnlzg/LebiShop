...
<body class="fix-sidebar fix-header card-no-border">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><%=Tag("文件编辑")%></li>
            ...
            <div class="card-body">
                <form action="javascript:SaveObj();" novalidate>
                    <div class="form-group">
                        <label for="SkinContent"><%=Tag("内容")%>：</label>
                        <textarea id="SkinContent" name="SkinContent" rows="6" class="form-control" style="height:300px;" shop="true"><%=Server.HtmlEncode(SkinContent)%></textarea>
                        ...
                        <small class="form-text text-muted"><%=Tag("每行一个文件，以“/”开头。")%></small>
                    </div>
                    <%if (PageReturnMsg == ""){%>
