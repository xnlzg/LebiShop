...
<body class="fix-sidebar fix-header card-no-border">
    ...
    <h3 class="text-themecolor m-b-0 m-t-0"><%=Tag("部门管理")%></h3>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<%=site.AdminPath %>/Ajax/ajax_admin.aspx?__Action=MenuJump&pid=0"><%=Tag("管理首页")%></a></li>
        <li class="breadcrumb-item"><a href="ServicePanel.aspx"><%=Tag("客服面板")%></a></li>
        <li class="breadcrumb-item active"><%=Tag("部门管理")%></li>
    </ol>
                ...
                <div class="row">
                    <div class="card-body inbox-panel p-t-0 p-b-0">
                        <ul class="list-group list-group-full">
                            ...
                            <li class="list-group-item active"><a href="ServicePanel_Group.aspx"><i class="ti-support"></i> <%=Tag("部门管理")%></a></li>
...
<div class="modal fade" id="Modal-Confirm" tabindex="-1" role="dialog" aria-labelledby="Confirm">
    ...
    <script>
        ...
        function Edit(id) {
            ...
            $("#EditModal").modal("show");
            $.ajax({
                url: "servicepanel_group_edit_window.aspx",
                type: "GET",
                cache: false,
