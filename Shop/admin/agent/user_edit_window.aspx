    ...
    <form action="javascript:SaveObj();" novalidate>
        ...
        <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="Angent1_Commission" name="Angent1_Commission" value="<%=model.Angent1_Commission %>" shop="true">
                <small class="form-text text-muted">% <%=Tag("继承填写")%>-1</small>
            </div>
            <div class="form-group">
                <label for="Angent2_Commission"><%=Tag("二级佣金")%>：</label>
                <input type="text" class="form-control" id="Angent2_Commission" name="Angent2_Commission" value="<%=model.Angent2_Commission %>" shop="true">
                <small class="form-text text-muted">% <%=Tag("继承填写")%>-1</small>
            </div>
            <div class="form-group">
                <label for="Angent3_Commission"><%=Tag("三级佣金")%>：</label>
                <input type="text" class="form-control" id="Angent3_Commission" name="Angent3_Commission" value="<%=model.Angent3_Commission %>" shop="true">
                <small class="form-text text-muted">% <%=Tag("继承填写")%>-1</small>
            </div>
        </div>
