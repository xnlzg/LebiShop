<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.product.product_Name_Edit_window" validateRequest="false"%>
    ...
    <form action="javascript:SavePNameObj();" novalidate>
        <div class="modal-header">
            <h4 class="modal-title"><%=Tag("编辑商品名称")%></h4>
            ...
            <div class="tab-content m-t-20">
                ...
                <div class="tab-pane <%if (langs.FirstOrDefault().Code == lang.Code){%>active show<%}%>" id="lang_<%=lang.Code %>" role="tabpanel">
                    <div class="form-group">
                        ...
                        <input type="text" id="Name<%=lang.Code %>" name="Name<%=lang.Code %>" value="<%=Shop.Bussiness.Language.Content(model.Name,lang.Code) %>" <%if (langs.FirstOrDefault().Code == lang.Code){%>required<%}%> class="form-control" shopname="true">
                    </div>
                </div>
                <%} %>
            </div>
