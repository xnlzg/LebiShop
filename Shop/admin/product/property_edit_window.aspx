<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.product.Property_Edit_window" validateRequest="false"%>
    ...
    <form action="javascript:SaveObj();" novalidate>
        ...
        <div class="modal-body" style="max-height:500px;overflow-y:auto;">
            ...
            <div class="form-group">
                <label for="Type_id_ProPertyType"><%=Tag("类型")%>：</label>
            ...
            <div class="form-group">
                <label for="Tag"><%=Tag("标签")%>：</label>
                <input type="text" id="Tag" name="Tag" value="<%=model.Tag %>" class="form-control" shop="true">
            </div>
            <div class="form-group">
                <label for="Remark"><%=Tag("备注")%>：</label>
                <input type="text" id="Remark" name="Remark" value="<%=model.Remark %>" class="form-control" shop="true">
            </div>
            <div class="form-group">
            ...
            <div id="supplier_box" class="form-group">
