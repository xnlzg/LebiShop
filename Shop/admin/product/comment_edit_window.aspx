<%@ Page Language="C#" AutoEventWireup="true" Inherits="Shop.Admin.Product.Comment_Edit_window" validateRequest="false"%>
    ...
    <form action="javascript:SaveObj();" novalidate>
        ...
        <div class="modal-body" style="max-height:500px;overflow-y:auto;">
            ...
            <div class="form-group">
                <label for="Status"><%=Tag("状态")%>：</label>
                <select name="status" class="form-control" shop="true">
    ...
    <script>
        ...
        function SaveObj() {
            ...
            var url = "<%=site.AdminPath %>/ajax/ajax_product.aspx?__Action=Comment_Edit&id=<%=model.id %>";
        ...
        function delitem(id) {
            ...
            var postData = "";
            var url = "<%=site.AdminPath %>/ajax/ajax_product.aspx?__Action=Comment_Del&Delid="+ id;
